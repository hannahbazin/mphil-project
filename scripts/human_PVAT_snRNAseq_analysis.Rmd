...
annot_dot_plot <- DotPlot(libs_combined_filt,
        features = c(
          ...
          # Pre-adipocytes
          "NEGR1", "EBF2", "DCN", "MGP", "PDGFRA", "FBLN1", "FBLN2", "FBLN5", "COL3A1", "COL1A1", "COL1A2", "FSTL1", "GSN", "ADAMTSL3", "CREB5",
          ...
          # Pericyte and VSMC
          "PDGFRB", "NOTCH3", "GUCY1A2", "GUCY1A1",
          
          # VSMC
          "MYH11", "MYO1D", "RYR2", "ACTA2", "CNN1", "DES",
...
DimPlot(libs_combined_filt, reduction = "umap",  ncol = 3, label = TRUE)

```

Save the final annotated UMAP plot.
...
pdf("results/humanPVATsn/umap_annot.pdf", width = 12, height = 8)
print(final_umap)
invisible(dev.off())
