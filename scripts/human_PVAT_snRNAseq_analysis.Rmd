...
p1 <- DimPlot(libs_combined,
              reduction = "umap",
              group.by = "sampleType") +
  ggtitle("tSNE coloured by sample origin")
...
libs_combined <- FindClusters(libs_combined, resolution = 0.5, random.seed = 1996)
