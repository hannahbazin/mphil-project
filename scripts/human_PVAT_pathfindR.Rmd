...
step1_filtered$Theme <- c(
  ...
  theme_list[2],  # regulation of Cdc42 protein signal transduction
...
plots_by_theme <- lapply(names(data_by_theme), function(theme) {
  ...
  ggplot(df, aes(x = Fold_Enrichment, y = Term_Description)) +
    geom_col(width = 1, fill = "#FDD866", color = "black") +
    xlim(0, max_value) +
    labs(x = NULL, y = theme) +
    theme_minimal() +
    theme(
      axis.title.y = element_text(angle = 90, hjust = 0.5, face = "bold", size = 9),
...
final_plot <- combined_plot + plot_annotation(
  ...
  theme = theme(
    ...
    plot.caption = element_text(hjust = 0.8, size = 9))
)

# Save and display
ggsave("results/humanPVATsn/pathfindR/full/step1_split.pdf", final_plot, width = 9, height = 7)
print(final_plot)
...
plots_by_theme <- lapply(names(data_by_theme), function(theme) {
  df <- data_by_theme[[theme]]
  ggplot(df, aes(x = Fold_Enrichment, y = Term_Description)) +
    geom_col(width = 1, fill = "#F46D43", color = "black") +
    xlim(0, max_value) +
    labs(x = NULL, y = theme) +
    theme_minimal() +
    theme(
...
# Save and display
ggsave("results/humanPVATsn/pathfindR/full/step2_split.pdf", final_plot, width = 9, height = 7)
print(final_plot)
...
plots_by_theme <- lapply(names(data_by_theme), function(theme) {
  df <- data_by_theme[[theme]]
  ggplot(df, aes(x = Fold_Enrichment, y = Term_Description)) +
    geom_col(width = 1, fill = "#D73027", color = "black") +
    xlim(0, max_value) +
    labs(x = NULL, y = theme) +
    theme_minimal() +
    theme(
...
# Add global title and x-axis
final_plot <- combined_plot + plot_annotation(
  title = "Top pathways enriched in step 3 (transitional to mature adipocytes)",
  caption = "Fold enrichment",
  theme = theme(
    plot.title = element_text(hjust = 0.5, size = 13, face = "bold"),
    plot.caption = element_text(hjust = 0.8, size = 9))
...
# Save and display
ggsave("results/humanPVATsn/pathfindR/full/step3_split.pdf", final_plot, width = 9, height = 7)
print(final_plot)
...
plots_by_theme <- lapply(names(data_by_theme), function(theme) {
  df <- data_by_theme[[theme]]
  ggplot(df, aes(x = Fold_Enrichment, y = Term_Description)) +
    geom_col(width = 1, fill = "#2166AC", color = "black") +
    xlim(0, max_value) +
    labs(x = NULL, y = theme) +
    theme_minimal() +
    theme(
...
# Add global title and x-axis
final_plot <- combined_plot + plot_annotation(
  title = "Top pathways enriched in full differentiation (early preadipocytes to mature adipocytes)",
  caption = "Fold enrichment",
  theme = theme(
    plot.title = element_text(hjust = 0.5, size = 13, face = "bold"),
    plot.caption = element_text(hjust = 0.8, size = 9))
...
# Save and display
ggsave("results/humanPVATsn/pathfindR/full/full_diff_split.pdf", final_plot, width = 9, height = 7)
print(final_plot)
