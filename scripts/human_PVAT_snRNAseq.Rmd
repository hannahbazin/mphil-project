...
final_feature <- wrap_plots(feature_plots) + 
  plot_annotation(title = "Feature plot of marker genes of PVAT cell populations (snRNA-seq)",
...
heat_map <- pheatmap(expr_matrix,
         ...
         cluster_cols = FALSE,
         color = colorRampPalette(c("white", "firebrick3"))(100),
         main = "Log-normalised expression of LRP1, MME, and CD36 across adipocyte differentiation",
...
neuro_heatmap <- pheatmap(neuro_pathways,
         ...
         main = "Progressive enrichment of neurogenic pathways during adipocyte differentiation",
         display_numbers = display_vals,
         fontsize_row = 12,
         fontsize_col = 12,
         fontsize_number = 10,
...
amyloid_heatmap <- pheatmap(amyloid_pathways,
         ...
         cluster_cols = FALSE,
         color = colorRampPalette(c("white", "steelblue"))(100),
         main = "Progressive enrichment of amyloid-related pathways during adipocyte differentiation",
         display_numbers = display_vals,
         fontsize_row = 12,
         fontsize_col = 12,
         fontsize_number = 10,
