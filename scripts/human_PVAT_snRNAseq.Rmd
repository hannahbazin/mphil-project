...
# Define cluster colours (keeping your original colors)
namedclusterColours <-
  list(
...
# Define marker genes to plot (keeping your original list)
markers_to_plot <- c(
          ## Adipocyte-related
          # Preadipocytes
...
final_figure <- complete_figure +
  plot_layout(heights = c(0.8, 1.3, 1.3)) +
  plot_annotation(tag_levels = list(c("A", "B", "C", "D"))) &
  theme(plot.tag = element_text(size = 19, face = "plain"))

# Save the complete figure
if (!dir.exists("results/humanPVATsn/final_figs")) dir.create("results/humanPVATsn/final_figs")

pdf("results/humanPVATsn/final_figs/complete_PVAT_analysis.pdf", width = 15, height = 17)
print(final_figure)
invisible(dev.off())
