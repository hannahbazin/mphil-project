...
gsea.res <- GSEA(geneList, TERM2GENE = pathways, by = "fgsea", seed = TRUE,  pvalueCutoff = 0.05) #NB GSEA function is from clusterProfiler package
...
#Make a bar plot of results (see clusterProfiler package )
